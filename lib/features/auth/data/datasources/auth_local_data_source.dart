...
class AuthLocalDataSource {
  ...
  Future<void> persistSession(UserSession session) async {
    ...
    await HiveService.authBox
        .put(LocalStorageKeys.authRememberMe, session.rememberMe);
    await HiveService.authBox.put(LocalStorageKeys.authEmail, session.email);
    await HiveService.authBox
        .put(LocalStorageKeys.authUsername, session.username);
  }
  ...
  Future<UserSession?> restoreSession() async {
    ...
    final bool rememberMe = HiveService.authBox
        .get(LocalStorageKeys.authRememberMe, defaultValue: false) as bool;
    final String email = HiveService.authBox
        .get(LocalStorageKeys.authEmail, defaultValue: '') as String;
    final String username = HiveService.authBox
        .get(LocalStorageKeys.authUsername, defaultValue: '') as String;
